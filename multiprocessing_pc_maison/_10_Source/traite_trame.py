...
def decompose_trame(dico_supervision,fifo,queue_log):
    global my_logger
    # log_multi_file.worker_configurer(queue_log)
    my_logger = logging.getLogger('traite_trame')
...
def gestion_trame(ma_trame,dico_supervision,fifo):
    ...
    if ((trame_agv[0] == 0x10) and (trame_agv[1] == 0x02)):
        ...
        # print (f'Gestion Trame ______ my_loggeur = {my_logger}')
...
def gest_log(queue_log):
    # global my_logger
    # log_multi_file.worker_configurer(queue_log)
    # my_logger = logging.getLogger('traite_trame')
    print (f'Gest_log ___!!!!!!!!!!!___ my_loggeur = {my_logger}')
